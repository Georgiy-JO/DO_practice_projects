...
Introduction to docker. Developing a simple docker image.
...
1. [Theory](#theory)  
    ...
    1.2. [Docker](#docker)  
    1.3. [Dockle](#dockle)  
    1.4. [Helping files](#helping-files)
2. [Tasks](#tasks)  
...
### Helping files:
* [mini_server](/Do-Docker/theory/materials/mini_server.md)
* [nginx_status](/Do-Docker/theory/materials/nginx_status.md)
...
## Part 1. Ready-made docker of **nginx**
